// packages/node/start.js — Point d'entrée SkyAInet (binaire standalone)
// =====================================================
...
import { SkyTray }    from '#tray';       // packages/node/tray.js
import { Autostart }  from '#autostart';  // packages/node/autostart.js
import { SkyUpdater } from '#updater';    // packages/node/updater.js
